...
def run_app(run_dialog=True):
    ...
    sep = "/"
    rfile_name = "axi_dataset_cleaned_dw_fact.csv"
    ...
    intg_cols = ['account_nr',
                 'ticket',
                 'open_date_key',
                 'close_date_key']
    date_cols = ['open_datetime',
                 'close_datetime']
    ...
    db_table_name = 'axi_trade_history'
    db_schema = 'staging'
    ...
    # print(db_rec_del)
    print(final_df['account_nr'].value_counts())
